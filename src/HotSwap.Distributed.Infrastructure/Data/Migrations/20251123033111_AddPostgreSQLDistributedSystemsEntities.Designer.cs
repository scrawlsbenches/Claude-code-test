...
namespace HotSwap.Distributed.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251123033111_AddPostgreSQLDistributedSystemsEntities")]
    partial class AddPostgreSQLDistributedSystemsEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotSwap.Distributed.Infrastructure.Data.Entities.ApprovalRequestEntity", b =>
                {
                    b.Property<Guid>("DeploymentExecutionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<string>>("ApproverEmails")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.HasKey("DeploymentExecutionId");
            ...
            modelBuilder.Entity("HotSwap.Distributed.Infrastructure.Data.Entities.DeploymentJobEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ProcessingInstance")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HotSwap.Distributed.Infrastructure.Data.Entities.MessageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Topic", "Priority")
                        .IsDescending()
                        .HasDatabaseName("idx_messages_pending")
                        .HasFilter("status = 'Pending'");

                    b.HasIndex("Topic", "Priority", "CreatedAt")
